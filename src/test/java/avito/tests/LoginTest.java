...
public class LoginTest extends TestBase {
    ...
    @Test
    @DisplayName("Появление капчи при заполнении некорректных логина и пароля, ошибка 'Почта не привязана к профилю. " +
    ...
    @Test
    @DisplayName("Появление капчи при заполнении некорректных логина и пароля, ошибка 'Длина логина не должна " +
