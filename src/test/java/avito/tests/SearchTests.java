...
public class SearchTests extends TestBase {
    ...
    @ParameterizedTest(name = "Поиск объявлений по ключевому слову - {2} через корневую категорию 'Животные', подкатегории - {1} с 0 результатом")
    @Tag("BLOCKER")
    public void searchWordInRootCategoryAnimalsWith0ResultTest(int subcategoryNum, String subcategoryText, String searchWord) {
    ...
    @ParameterizedTest(name = "Поиск объявлений по ключевому слову - {0}, c результатом больше 0 и с выбором первой выпадающей категории - {1}")
    @Tag("SMOKE")
    ...
    @Tag("SMOKE")
    public void selectingPopularCategoriesOnMainPageTest(String popularCategory, int subcategory1, int subcategory2, String categoryText1, String categoryText2, String foundWord) {
