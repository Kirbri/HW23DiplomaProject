...
public class FavoriteTests extends TestBase {
    ...
    @Test
    @DisplayName("Добавление объявления в избранное и просмотр через кнопку 'Избранное'")
    @Tag("BLOCKER")
    ...
    @Test
    @DisplayName("Добавление объявления в избранное с возможностью посмотреть его")
    @Tag("SMOKE")
